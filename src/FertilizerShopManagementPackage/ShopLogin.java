...
public class ShopLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPasswordField1.setPreferredSize(new java.awt.Dimension(7, 27));
        ...
        jLabel4.setText("RVY Fertilizers");

        jLabel5.setFont(new java.awt.Font("Times New Roman", 0, 24)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(204, 255, 255));
        jLabel5.setText("Management Log In");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            String q2="select * from LoginTable where LoginId='"+id+"'";
            ps=con.prepareStatement(q2);
            rs=ps.executeQuery();
            while(rs.next())
            {
                if((id.equals(rs.getString(1)))&&(name.equals(rs.getString(2)))&& (pass.equals(rs.getString(3))))
                {
